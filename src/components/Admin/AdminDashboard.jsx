...
const AdminDashboard = () => {
  ...
  const fetchAllData = async () => {
    ...
    try {
      const [heroRes, servicesRes, awardsRes, galleryRes, aboutRes] = await Promise.all([
        axios.get('https://sateesh-kumar-portfolio.vercel.app/api/hero').catch(() => ({ data: {} })),
        axios.get('https://sateesh-kumar-portfolio.vercel.app/api/services').catch(() => ({ data: [] })),
        axios.get('https://sateesh-kumar-portfolio.vercel.app/api/awards').catch(() => ({ data: [] })),
        axios.get('https://sateesh-kumar-portfolio.vercel.app/api/gallery?limit=100').catch(() => ({ data: [] })),
        axios.get('https://sateesh-kumar-portfolio.vercel.app/api/about/sections').catch(() => ({ data: [] }))
      ]);
  ...
  const saveHeroImage = async (imageUrl) => {
    try {
      ...
      const response = await axios.put('https://sateesh-kumar-portfolio.vercel.app/api/hero', updatedHero);
  ...
  const saveServiceImage = async (serviceId, imageUrl, title) => {
    try {
      ...
      const response = await axios.put(`https://sateesh-kumar-portfolio.vercel.app/api/services/${serviceId}`, { 
        ...service, 
  ...
  const saveAwardImage = async (awardId, imageUrl, title) => {
    try {
      ...
      const response = await axios.put(`https://sateesh-kumar-portfolio.vercel.app/api/awards/${awardId}`, { 
        ...award, 
        images: updatedImages,
  ...
  const saveAboutImage = async (sectionId, imageUrl) => {
    try {
      const response = await axios.put(`https://sateesh-kumar-portfolio.vercel.app/api/about/sections/${sectionId}`, { image: imageUrl });
      return response.data;
    } catch (error) {
  ...
  const saveGalleryItem = async (imageUrl, title, category = 'general') => {
    try {
      const response = await axios.post('https://sateesh-kumar-portfolio.vercel.app/api/gallery', {
        title,
        image: imageUrl,
        category,
...
const HeroManagement = ({ data, onUpload, uploading, uploadProgress, onRefresh }) => {
  ...
  const updateHero = async (updates) => {
    try {
      const response = await axios.put('https://sateesh-kumar-portfolio.vercel.app/api/hero', { ...hero, ...updates });
                ...
                <div className="mt-4">
                  ...
                  <div className="relative">
                    ...
                    <button
                      onClick={async () => {
                        try {
                          await axios.put('https://sateesh-kumar-portfolio.vercel.app/api/hero', { ...hero, image: '' });
...
const ServicesManagement = ({ data, onUpload, uploading, uploadProgress, onRefresh }) => {
  ...
  const createService = async () => {
    try {
      ...
      const response = await axios.post('https://sateesh-kumar-portfolio.vercel.app/api/services', serviceToCreate);
  ...
  const updateService = async (serviceId, updates) => {
    try {
      const response = await axios.put(`https://sateesh-kumar-portfolio.vercel.app/api/services/${serviceId}`, updates);
  ...
  const deleteService = async (serviceId) => {
    if (window.confirm('Are you sure you want to delete this service?')) {
      try {
        await axios.delete(`https://sateesh-kumar-portfolio.vercel.app/api/services/${serviceId}`);
  ...
  const setMainImage = async (serviceId, imageUrl) => {
    try {
      await axios.put(`https://sateesh-kumar-portfolio.vercel.app/api/services/${serviceId}`, { mainImage: imageUrl });
      onRefresh();
  ...
  const deleteServiceImage = async (serviceId, imageUrl) => {
    if (window.confirm('Are you sure you want to delete this image?')) {
      try {
        ...
        await axios.put(`https://sateesh-kumar-portfolio.vercel.app/api/services/${serviceId}`, {
          ...service,
          images: updatedImages,
...
const AwardsManagement = ({ data, onUpload, uploading, uploadProgress, onRefresh }) => {
  ...
  const createAward = async () => {
    try {
      ...
      const response = await axios.post('https://sateesh-kumar-portfolio.vercel.app/api/awards', awardToCreate);
  ...
  const updateAward = async (awardId, updates) => {
    try {
      const response = await axios.put(`https://sateesh-kumar-portfolio.vercel.app/api/awards/${awardId}`, updates);
  ...
  const deleteAward = async (awardId) => {
    if (window.confirm('Are you sure you want to delete this award?')) {
      try {
        await axios.delete(`https://sateesh-kumar-portfolio.vercel.app/api/awards/${awardId}`);
  ...
  const setMainImage = async (awardId, imageUrl) => {
    try {
      await axios.put(`https://sateesh-kumar-portfolio.vercel.app/api/awards/${awardId}`, { mainImage: imageUrl });
      onRefresh();
      alert('Main image set successfully!');
    } catch (error) {
      console.error('Set main image error:', error);
  ...
  const deleteAwardImage = async (awardId, imageUrl) => {
    if (window.confirm('Are you sure you want to delete this image?')) {
      try {
        ...
        await axios.put(`https://sateesh-kumar-portfolio.vercel.app/api/awards/${awardId}`, {
          ...award,
          images: updatedImages,
...
const AboutManagement = ({ data, onUpload, uploading, uploadProgress, onRefresh }) => {
  ...
  const createSection = async () => {
    try {
      ...
      const response = await axios.post('https://sateesh-kumar-portfolio.vercel.app/api/about/sections', sectionToCreate);
  ...
  const updateSection = async (sectionId, updates) => {
    try {
      const response = await axios.put(`https://sateesh-kumar-portfolio.vercel.app/api/about/sections/${sectionId}`, updates);
  ...
  const deleteSection = async (sectionId) => {
    if (window.confirm('Are you sure you want to delete this section?')) {
      try {
        await axios.delete(`https://sateesh-kumar-portfolio.vercel.app/api/about/sections/${sectionId}`);
  ...
  const deleteSectionImage = async (sectionId) => {
    if (window.confirm('Are you sure you want to delete this image?')) {
      try {
        await axios.put(`https://sateesh-kumar-portfolio.vercel.app/api/about/sections/${sectionId}`, { image: '' });
        onRefresh();
        alert('Image deleted successfully!');
      } catch (error) {
        console.error('Delete image error:', error);
...
const GalleryManagement = ({ data, onUpload, uploading, uploadProgress, onRefresh }) => {
  ...
  const deleteGalleryItem = async (itemId) => {
    if (window.confirm('Are you sure you want to delete this image?')) {
      try {
        await axios.delete(`https://sateesh-kumar-portfolio.vercel.app/api/gallery/${itemId}`);
